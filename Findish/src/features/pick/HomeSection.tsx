  ...
  return (
    <div className="flex flex-col h-full">
      <div className="px-3 pt-3 shrink-0">
        <div className="relative w-full h-65 overflow-hidden rounded-[10px]">
          <img
      ...
      <div className="flex-1 overflow-y-auto px-5 py-4 flex flex-col gap-4">
        ...
        <div>
          ...
          <p className="typo-body-sm text-neutral-600">
            사람들은 주로{' '}
            <span className="font-bold text-primary-dark">1인당 {restaurant.priceRange}</span>을 사용해요
          </p>
        </div>
        <div>
          ...
          <p className="typo-body-sm text-neutral-600">
            현재 위치에서{' '}
            <span className="font-bold text-primary-dark">{restaurant.distance}</span> 떨어져 있어요.
          </p>
          <p className="typo-body-sm text-neutral-500 mt-0.5">{restaurant.station}</p>
        </div>
      </div>
    </div>
  );
